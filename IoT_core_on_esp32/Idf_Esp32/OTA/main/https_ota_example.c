...
#define FIRMWARE_VERSION	0.1            /*#define FIRMWARE_VERSION	0.2*/
#define UPDATE_JSON_URL		"https://aerogramhq.gitlab.io/iot/esp_idf_ota/ota.json"
#define BLINK_GPIO 			GPIO_NUM_2    /*#define BLINK_GPIO 			GPIO_NUM_18*/
